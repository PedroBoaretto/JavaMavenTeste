...
@tag
Feature: Cliente fz saque de dinheiro como um cliente, eu gostaria de sacar dinheiro em caixa eletronico,
 para que eu nao tenha que esperar numa fila de banco.

  @tag1
  Scenario: Cliente especial com saldo negativo
    Given um cliente especial com saldo negativo de -200 reais
